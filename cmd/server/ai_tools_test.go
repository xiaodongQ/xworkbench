...
func TestExecuteTool_Unknown(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "unknown_tool_xyz", `{}`)
	if result == "" {
...
func TestExecuteTool_CreateTask(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_task", args)
...
func TestExecuteTool_ListTasks_Empty(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_tasks", `{}`)
...
func TestExecuteTool_GetTask(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "get_task", `{"task_id":"`+task.ID+`"}`)
...
func TestExecuteTool_GetTask_NotFound(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "get_task", `{"task_id":"non-existent-id"}`)
...
func TestExecuteTool_UpdateTask(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "update_task", args)
...
func TestExecuteTool_UpdateTask_NotFound(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "update_task", `{"task_id":"non-existent","title":"new"}`)
...
func TestExecuteTool_TriggerTask(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "trigger_task", args)
...
func TestExecuteTool_ListTaskExecutions(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_task_executions", `{"task_id":"`+task.ID+`"}`)
...
func TestExecuteTool_CreateWebLink(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_web_link", args)
...
func TestExecuteTool_CreateWebLink_MissingFields(t *testing.T) {
	srv := newTestServerForTools(t)
	// 缺少必填字段
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_web_link", `{"name":""}`)
...
func TestExecuteTool_ListWebLinks_Empty(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_web_links", `{}`)
...
func TestExecuteTool_ListWebLinks_WithData(t *testing.T) {
	...
	ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil,
...
func TestExecuteTool_UpdateWebLink(t *testing.T) {
	...
	id := list[0].ID
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil,
...
func TestExecuteTool_DeleteWebLink(t *testing.T) {
	...
	id := list[0].ID
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "delete_web_link", `{"id":"`+id+`"}`)
...
func TestExecuteTool_CreateExperience(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_experience", args)
...
func TestExecuteTool_CreateExperience_MissingModule(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_experience", `{"keywords":"test"}`)
...
func TestExecuteTool_SearchExperiences(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "search_experiences", `{"query":"git"}`)
...
func TestExecuteTool_SearchExperiences_NoResults(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "search_experiences", `{"query":"xyznonexistent999"}`)
...
func TestExecuteTool_UpdateExperience(t *testing.T) {
	srv := newTestServerForTools(t)
	// 创建
	createResult := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil,
...
func TestExecuteTool_CreateDirShortcut_Local(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_dir_shortcut", args)
...
func TestExecuteTool_CreateDirShortcut_MissingName(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "create_dir_shortcut", `{"type":"local","path":"/tmp"}`)
...
func TestExecuteTool_ListDirShortcuts_Empty(t *testing.T) {
	srv := newTestServerForTools(t)
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_dir_shortcuts", `{}`)
...
func TestExecuteTool_ListDirShortcuts_WithFilter(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_dir_shortcuts", `{"type":"local"}`)
...
func TestExecuteTool_AddTodo(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "add_todo", args)
...
func TestExecuteTool_ListTodos(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, nil, "list_todos", `{}`)
...
func TestExecuteTool_StartLocalShell(t *testing.T) {
	...
	result := ExecuteTool(context.Background(), srv.db, srv.expDB, srv.execDB, srv.agentDB, srv.linkDB, srv.dirDB, srv.schedDB, nil, nil, state,
