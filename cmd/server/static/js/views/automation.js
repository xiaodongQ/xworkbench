...
async function loadScheduled() {
  ...
  el.innerHTML = sortedCats.map((cat, catIndex) => {
    ...
    const colgroup = '<colgroup><col style="width:auto"><col style="width:130px"><col style="width:60px"><col style="width:80px"><col style="width:150px"><col style="width:320px"></colgroup>';
