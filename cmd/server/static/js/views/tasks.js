...
function renderTaskTable(list) {
  ...
  el.innerHTML = sortedCats.map((cat, catIndex) => {
    ...
    const thead = catIndex === 0
      ...
      : '';
    const colgroup = `<colgroup><col style="width:auto"><col style="width:80px"><col style="width:60px"><col style="width:56px"><col style="width:150px"><col style="width:320px"></colgroup>`;
